...
class ExpressJSFramework(Extension):
    ...
    def _gen_override_build(self) -> str:
        ...
        """
        # Q: here is a problem: if package.json is in the same dir as rockcraft.yaml
        # the YAML file will be included unless explicitly excluded by the
        # project's config. An alternative:
        # 1. If .npmignore exists, append rockcraft.yaml there
        # 2. If .gitignore exists, append rockcraft.yaml there
